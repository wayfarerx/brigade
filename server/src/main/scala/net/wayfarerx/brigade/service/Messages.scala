...
import net.wayfarerx.brigade.model_old.{User, Role, Roster, Team}
...
object Messages {
  ...
  def help: String =
    """hi, I'm the Brigade team builder, progeny of the inimitable wayfarerx.
      ...
      |For a more detailed tutorial about how this bot works see https://github.com/wayfarerx/brigade.
    """.stripMargin
